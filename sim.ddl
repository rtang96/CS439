...
ALTER TABLE SIM_team ADD CONSTRAINT SIM_team_PK PRIMARY KEY ( team_id ) ;
...
ALTER TABLE SIM_team ADD CONSTRAINT SIM_team_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE SIM_team ADD CONSTRAINT SIM_team_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
